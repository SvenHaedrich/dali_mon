class DALIError:
    ...
    def __init__(self, error_code=0, data=0):
        ...
        error_dictionary = {
            ...
            self.FRAME: "ERROR: INVALID FRAME",
    ...
    def __str__(self):
        ...
        if (
            self.error_code == self.RECEIVE_START_TIMING
            or self.error_code == self.RECEIVE_DATA_TIMING
            or self.error_code == self.LOOPBACK_TIME
        ):
